"""
Combined Effects Widgets Part 2
===============================

Widgets pour les effets combinés restants du Magicstomp.
"""
...
class ReverbArrowChorusWidget(BaseEffectWidget):
...
class ReverbSymphonicWidget(BaseEffectWidget):
    ...
    def get_all_parameters(self):
        ...
        params['high_pass_filter'] = self.get_parameter_value("High Pass Filter")
        params['low_pass_filter'] = self.get_parameter_value("Low Pass Filter")
        params['reverb_symphonic'] = self.get_parameter_value("Reverb/Symphonic")
    ...
    def set_all_parameters(self, params):
        ...
        if 'low_pass_filter' in params:
            self.set_parameter_value("Low Pass Filter", params['low_pass_filter'])
        if 'reverb_symphonic' in params:
            self.set_parameter_value("Reverb/Symphonic", params['reverb_symphonic'])
        if 'depth' in params:
