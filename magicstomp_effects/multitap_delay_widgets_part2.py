"""
Multi-Tap Delay Widgets Part 2
==============================

Widgets pour les effets de delay multi-tap restants du Magicstomp.
"""
...
class EightBandSeriesDelayWidget(BaseEffectWidget):
    """Widget pour l'effet 8 Band Series Delay du Magicstomp."""
    ...
    def _create_widgets(self):
        """Crée l'interface du 8 Band Series Delay."""
        # Titre
        title = ttk.Label(self, text="8 Band Series Delay", font=("Arial", 12, "bold"))
        ...
        note = ttk.Label(self, text="Note: Only Band 1 parameters shown. Full version would have 8 bands in series.", 
                        font=("Arial", 8, "italic"), foreground="gray")
        note.grid(row=9, column=0, columnspan=6, pady=(5, 0))
    
    def get_all_parameters(self):
        """Retourne tous les paramètres du 8 Band Series Delay."""
        params = {}
        
        # 8 Band Series Delay parameters
    ...
    def set_all_parameters(self, params):
        """Applique tous les paramètres du 8 Band Series Delay."""
        # 8 Band Series Delay parameters
...
class TwoBandFourTapModDelayWidget(BaseEffectWidget):
    """Widget pour l'effet 2 Band 4 Tap Mod. Delay du Magicstomp."""
    ...
    def _create_widgets(self):
        """Crée l'interface du 2 Band 4 Tap Mod. Delay."""
        # Titre
        title = ttk.Label(self, text="2 Band 4 Tap Mod. Delay", font=("Arial", 12, "bold"))
        title.grid(row=0, column=0, columnspan=6, pady=(0, 10))
        ...
        # Note: Pour simplifier, on ne montre que les paramètres de la première bande
        note = ttk.Label(self, text="Note: Only Band 1 parameters shown. Full version would have 2 bands with 4 taps each.", 
                        font=("Arial", 8, "italic"), foreground="gray")
        note.grid(row=9, column=0, columnspan=6, pady=(5, 0))
    
    def get_all_parameters(self):
        """Retourne tous les paramètres du 2 Band 4 Tap Mod. Delay."""
        params = {}
        
        # 2 Band 4 Tap Mod. Delay parameters
        params['wave_form'] = self.get_parameter_value("Wave Form")
        params['effect_level'] = self.get_parameter_value("Effect Level")
        params['direct_level'] = self.get_parameter_value("Direct Level")
        params['direct_pan'] = self.get_parameter_value("Direct Pan")
    ...
    def set_all_parameters(self, params):
        """Applique tous les paramètres du 2 Band 4 Tap Mod. Delay."""
        # 2 Band 4 Tap Mod. Delay parameters
        if 'wave_form' in params:
            self.set_parameter_value("Wave Form", params['wave_form'])
        if 'effect_level' in params:
